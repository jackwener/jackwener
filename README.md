...
- :crown: I worked in Bytedance RDS, Nebula-Graph, and had the internship in Tencent, Microsoft, Douyin.
...
- :rice_cracker: Love to participate Open Source, currently focus on `Datafusion`, `Apache/incubator-doris(Collaborator Now)` 
